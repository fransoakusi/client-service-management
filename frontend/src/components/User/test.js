...
const VisitorManagement = () => {
  ...
  return (
    <div className="container">
      <div className="header">CLIENT FLOW - NORTH TONGU CLIENT SERVICE MANAGEMENT SYSTEM</div>

      <div className="navbar">
        {["Dashboard", "Visitors", "Complaint", "Enquiry", "Enquiry Response", "Referral", "Report"].map((item) => (
          <button key={item} className="nav-button">{item}</button>
        ))}
